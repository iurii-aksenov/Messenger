...
export class AppComponent {
    ...
    contactForm: FormGroup = new FormGroup({
        ...
        "contactPassword": new FormControl("", [Validators.required])
    });

    onCreateContact() {
        if(this.contactForm.controls['contactPassword'].value == '01'&& this.contactForm.controls['contactPhone'].value == '01')
    ...
    /*
      ...
      //         this.newContact.sex, this.newContact.phone, this.newContact.email));
      //     let maxId: number = 0;
      //     this.contacts.forEach(item => {
